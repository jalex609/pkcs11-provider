...
// Vendor specific legacy Edwards params
#define CKM_EDDSA_LEGACY CKM_VENDOR_DEFINED + 0x0C03
#define CKM_EC_EDWARDS_KEY_PAIR_GEN_LEGACY CKM_VENDOR_DEFINED + 0x0C01
#define CKK_EC_EDWARDS_LEGACY 0x80000012UL
